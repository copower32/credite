        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
              <li>
                <Link to="/terminos" className="text-tertiary hover:text-white">
                  Términos y condiciones
                </Link>
              </li>
              <li>
                <Link to="/politica-privacidad" className="text-tertiary hover:text-white">
                  Política de privacidad
                </Link>
              </li>
              <li>
                <Link to="/politica-cookies" className="text-tertiary hover:text-white">
                  Política de cookies
                </Link>
              </li>
              </ul>
